...
<div id="prod">
	<div id="tarjeta">
		<p id="titletar">Agrege los datos de su tarjeta</p>
	<form action="gracias.php">
		<input id="nombre" type="text" placeholder="Nombre" required><br>
		<input id="num" type="int" placeholder="Numero de Tarjeta" required><br>
		<input id="cvc" type="int" placeholder="CVC" required> 
		<input id="mes" type="int" required placeholder="Mes">
		<input id="año" type="int" required placeholder="año"><br>
		<input id="submittar" type="submit">
	</form>
